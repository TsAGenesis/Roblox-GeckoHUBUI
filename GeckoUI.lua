...
local defaultCorner = UDim.new(0, 8)

local function addCorner(obj, radius)
    local c = Instance.new("UICorner")
    c.CornerRadius = radius or defaultCorner
    c.Parent = obj
    return c
end
...
function GeckoUI.CreateWindow(opts)
    ...
    addCorner(settingsScroll, UDim.new(0,6))
    ...
    local function addColorRow(labelText, themeKey)
        ...
        pickBtn.TextSize = 11
        pickBtn.ZIndex = 41
        addCorner(pickBtn, UDim.new(0,4))
