...
GeckoUI.WhiteTheme = {
    ...
    TitleBackground  = Color3.fromRGB(245, 245, 245),
    Accent           = Color3.fromRGB(0, 0, 0),

    ButtonPrimary    = Color3.fromRGB(235, 220, 190),
    ButtonDanger     = Color3.fromRGB(235, 220, 190),
    ButtonWarn       = Color3.fromRGB(235, 220, 190),
    ButtonCopy       = Color3.fromRGB(235, 220, 190),
    SettingsBlue     = Color3.fromRGB(235, 220, 190),

    ScrollBackground = Color3.fromRGB(248, 248, 248),
    TextMain         = Color3.fromRGB(0, 0, 0),
    TextMuted        = Color3.fromRGB(60, 60, 60),

    ToggleOff        = Color3.fromRGB(210, 210, 210),
    ToggleOn         = Color3.fromRGB(235, 220, 190),

    SliderTrack      = Color3.fromRGB(215, 215, 215),
    SliderFill       = Color3.fromRGB(235, 220, 190),

    TabBackground    = Color3.fromRGB(240, 240, 240),
    TabActive        = Color3.fromRGB(235, 220, 190),

    ToastInfo        = Color3.fromRGB(238, 238, 238),
    ToastSuccess     = Color3.fromRGB(238, 238, 238),
    ToastError       = Color3.fromRGB(238, 238, 238),

    ParticleColor1   = Color3.fromRGB(220, 220, 220),
    ParticleColor2   = Color3.fromRGB(200, 200, 200),
    ParticleMinSize  = 4,
    ParticleMaxSize  = 8,
    ParticleMinDelay = 0.8,
    ParticleMaxDelay = 1.8,
...
--   Draggable   = true,
--   AllowResize = false,
--   ThemeName   = "white" -- optional: use GeckoUI.WhiteTheme
-- }
...
function GeckoUI.CreateWindow(opts)
    ...
    local themeSource = GeckoUI.BaseTheme
    if opts.Theme then
        themeSource = opts.Theme
    elseif typeof(opts.ThemeName) == "string" then
        local lower = string.lower(opts.ThemeName)
        if lower == "white" or lower == "light" then
            themeSource = GeckoUI.WhiteTheme
        end
    end

    local theme     = cloneTheme(themeSource)
